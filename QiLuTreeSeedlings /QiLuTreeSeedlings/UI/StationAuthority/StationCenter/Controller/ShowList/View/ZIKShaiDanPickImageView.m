...
@interface ZIKShaiDanPickImageView ()<ZIKPickerBtnDeleteDelegate>

@property(nonatomic, strong) NSMutableArray *imageBtnArr;
@property(nonatomic, strong) UIButton       *pickBtn;

@end
@implementation ZIKShaiDanPickImageView
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        self.imageBtnArr = [NSMutableArray array];
        self.photos = [NSMutableArray array];
        self.urlMArr = [NSMutableArray array];
