...
#import "UIScrollView+KMJRefresh.h"
#import "KMJRefreshHeaderView.h"
#import "KMJRefreshFooterView.h"
#import <objc/runtime.h>

@interface UIScrollView()
@property (weak, nonatomic) KMJRefreshHeaderView *header;
@property (weak, nonatomic) KMJRefreshFooterView *footer;
@end


@implementation UIScrollView (KMJRefresh)

#pragma mark - 运行时相关
static char MJRefreshHeaderViewKey;
static char MJRefreshFooterViewKey;

- (void)setHeader:(KMJRefreshHeaderView *)header {
...
- (KMJRefreshHeaderView *)header {
    return objc_getAssociatedObject(self, &MJRefreshHeaderViewKey);
}

- (void)setFooter:(KMJRefreshFooterView *)footer {
...
- (void)addHeaderWithCallback:(void (^)())callback
{
    // 1.创建新的header
    if (!self.header) {
        KMJRefreshHeaderView *header = [KMJRefreshHeaderView header];
...
- (void)addFooterWithCallback:(void (^)())callback
{
    // 1.创建新的footer
    if (!self.footer) {
        KMJRefreshFooterView *footer = [KMJRefreshFooterView footer];
