...
//    }
    ...
    [_picPathStringsArray enumerateObjectsUsingBlock:^(NSString *  _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
        ...
        imageView.hidden = NO;
        [imageView setImageWithURL:[NSURL URLWithString:obj] placeholderImage:[UIImage imageNamed:@"MoRentu"]];///////////////
...
- (CGFloat)itemWidthForPicPathArray:(NSArray *)array
{
    if (array.count == 1) {
        ...
        CGFloat w = [UIScreen mainScreen].bounds.size.width > 320 ? ([UIScreen mainScreen].bounds.size.width-120)/3 : 70;
        return w;
    }
}
