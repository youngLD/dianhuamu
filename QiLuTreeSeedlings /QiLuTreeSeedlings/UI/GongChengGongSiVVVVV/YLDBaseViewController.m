...
-(UIView *)makeNavView
{
    ...
    UIButton *backBtn=[[UIButton alloc]initWithFrame:CGRectMake(12, 26, 60, 30)];
     [backBtn setTitle:@"点花木" forState:UIControlStateNormal];
    [backBtn.titleLabel setFont:[UIFont systemFontOfSize:16]];
    [backBtn setTitleColor:NavTitleColor forState:UIControlStateNormal];
